...
class ApiController extends Controller
{
    ...
    public function backup(Request $request, $token)
    {
        ...
        Process::run("mysqldump -u '" .env('DB_USERNAME'). "' --password='" .env('DB_PASSWORD'). "' Port_Pro_Panel > /var/www/html/app/storage/backup/".$ip_bk."-Port-Pro-Panel-".$date.".sql");
        $download=$_SERVER["SERVER_ADDR"].':'.env('PORT_PANEL')."/api/$token/backup/dl/".$ip_bk."-Port-Pro-Panel-".$date.".sql";
