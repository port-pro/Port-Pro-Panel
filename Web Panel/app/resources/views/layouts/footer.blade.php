        ...
        <div class="row">
            ...
            <div class="col-auto my-1">
                <ul class="list-inline footer-link mb-0">
                    ...
                    <li class="list-inline-item"><a href="https://github.com/port-pro/Port-Pro-Panel/blob/master/README-EN.md#supporting-us-hearts">Supporting us</a></li>
                    <li class="list-inline-item"><a href="https://github.com/port-pro/Port-Pro-Panel/">GitHub</a></li>
                </ul>
            </div>
        </div>
    </div>
