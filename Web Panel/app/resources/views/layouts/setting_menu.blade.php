<div class="card-body border-bottom pb-0">
    <ul class="nav nav-tabs analytics-tab" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a href="https://www.port-pro.online" target="_blank" class="nav-link" type="button" role="tab" aria-selected="false" tabindex="-1"><i class="ti ti-box-multiple"></i>&nbsp;&nbsp;{{__('setting-multiserver-menu')}}</a>
        </li>
        <li class="nav-item" role="presentation">
