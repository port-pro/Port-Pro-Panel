    ...
    <div class="navbar-wrapper">
        <div class="m-header">
            <a href="#" class="b-brand text-primary">
                ...
                <img src="/assets/images/xlogo.png" alt="Port-Pro-Panel" style="width:50px"/>
    ...
    <div class="header-wrapper"> <!-- [Mobile Media Block] start -->
        ...
        <div class="ms-auto">
            <ul class="list-unstyled">
                ...
                <li class="dropdown pc-h-item">
                    <a href="https://github.com/port-pro/Port-Pro-Panel" target="_blank">
                ...
                <li class="dropdown pc-h-item">
                    <a href="https://www.port-pro.online" target="_blank"><span class="badge bg-light-primary rounded-pill f-12"><i class="fas fa-donate"></i>&nbsp;{{__('donate')}}</span></a>
                </li>
                <li class="dropdown pc-h-item">
