...
@section('title','Port-Pro-Panel - '.__('premium'))
@section('content')
    <!-- [ Main Content ] start -->
                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-footer">
                                                    <div class="row text-center">
                                                            <div class="d-grid">
                                                                <a href="https://www.port-pro.online/api/license/repay?domain={{$license->domain}}" target="_blank" class="btn btn-primary d-grid"><span class="text-truncate w-100">{{__('premium-acc-renew')}}</span></a>
                                                            </div>
                                                    </div>
                                                </div>
                                            </div>
