...
@section('title','Port-Pro-Panel - '.__('settings-xguard-title'))
@section('content')
    <!-- [ Main Content ] start -->
                                ...
                                @if(isset($response[0]['message']) and $response[0]['message']=='access')
                                    <ul class="list-inline pt-2">
                                        ...
                                        <li class="list-inline-item">
                                            <a href="https://www.port-pro.online/api/repay?domain={{$response[0]['domain']}}" class="btn btn-primary color-block bg-blue-500 border" >{{__('settings-xguard-tamdid')}}</a>
